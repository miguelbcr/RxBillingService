...
public class NestedFragment extends Fragment {
  ...
  @Override public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    RxBillingService.getInstance(this)
        ...
        .subscribe(supported -> {
              Log.e("XXXXXXXXXXXXXXX", "NestedFragment: Billing supported = " + supported);
              textView.setText("NestedFragment: Billing supported = " + supported);
            },
            throwable -> {
              throwable.printStackTrace();
              textView.setText("NestedFragment: error = " + throwable.getMessage());
            }
        );
  }
}
